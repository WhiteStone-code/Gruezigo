...
const TABS = [
  { id: 'grammar', label: 'Gramática', icon: BookOpenText },
  { id: 'verbs', label: 'Verbos', icon: SpellCheck },
  { id: 'vocabulary', label: 'Vocabulario', icon: Library },
  { id: 'practice', label: 'Práctica', icon: Dumbbell },
...
export function ReviewHub({ onOpenLesson }) {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-6 space-y-4 pb-24">
      <div>
        <h2 className="font-display font-bold text-2xl text-alp-900 dark:text-alp-50">Repaso</h2>
        <p className="text-sm text-alp-500 dark:text-alp-300">Gramática, verbos, vocabulario y práctica libre.</p>
      </div>
